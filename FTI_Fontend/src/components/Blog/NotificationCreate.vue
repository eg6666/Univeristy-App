<template>
  <div class="editor__wrapper">
    ...
    <b-button @click="createNotification" block style="margin-top: 1em">Krijo</b-button>
  </div>
</template>
  ...
  methods: {
      async createNotification() {
          try {
            ...
            await this.$api.blog.createNotification(payload)
            this.$router.push('postime')
          } catch (err) {
            this.$notify({
                    group: "error",
                    title: "Error",
